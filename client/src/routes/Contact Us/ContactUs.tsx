    ...
    <Wrapper>
      <div className="grid md:grid-cols-3">
        <div className="flex flex-col justify-between">
          <div>
            <h1 className="text-gray-500 leading-tight lg:leading-[94px] text-5xl lg:text-[70px] mb-7 font-bold">
              Get in touch with us.
            </h1>
            <p className="font-normal text-lg md:text-xl leading-7 text-[#8C959F]">
        ...
        <div className="md:col-span-2 md:p-16 mt-16 md:mt-0">
          ...
          <form onSubmit={contact.handleSubmit(handleContactForm)}>
            <div className="grid gap-4 mb-14">
              <div className="grid sm:grid-cols-2 gap-4">
                <Input
                  ...
                  $isError={Object.keys(contact.formState.errors).includes(
                    "name"
                  )}
              ...
              <textarea
                className={`px-5 py-5 border border-[#E3E3E3] w-full outline-none resize-none ${
                  Object.keys(contact.formState.errors).includes("message") &&
                  `border-red-500`
                }`}
              ...
              <div>
                ...
                <label
                  className={`text-lg text-[#8C959F] ml-4 ${
                    Object.keys(contact.formState.errors).includes(
                      "accessTerms"
                    ) && "text-red-500"
                  }`}
                  htmlFor="privacy"
            ...
            <Button
              ...
              disabled={!contact.formState.isValid || contactMutation.isLoading}
            >
              Submit
            </Button>
          </form>
...
const Input = styled.input<{
  ...
  ${tw`px-5 py-5 border border-[#E3E3E3] outline-none`} ${({ $isError }) =>
    $isError ? tw`border-red-500` : tw``}
`;
