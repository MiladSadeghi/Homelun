...
const WhatWeDo = () => {
  return (
    <div>
      <div className="flex">
        <h2 className="font-bold text-7xl leading-[94px] w-full">
      ...
      <div className="mt-20 grid grid-cols-4 gap-6">
        <img
          src={Gallery1}
          className="col-span-3 object-cover h-[393px] w-full"
        />
        <img src={Gallery2} className=" object-cover h-[393px] w-full" />
        <img src={Gallery3} className=" object-cover h-[393px] w-full" />
        <img
          src={Gallery4}
          className="object-cover col-span-3 h-[393px] w-full "
        />
      </div>
    </div>
  );
