    ...
    return (
        <div>
            ...
            <div className="py-[30px] px-6">
                <Link to={`/listings/${property.slug}`} className="text-2xl text-gray-500 font-bold line-clamp-2 h-16">
                    {property.address}
                </Link>
                ...
                <div className="flex justify-between items-center mt-6">
                    <p className=" text-red-500 font-extrabold text-4xl leading-none flex flex-wrap">
                        {property.offPercent !== 0 ? (
                            <>
                                {calculateOffPercent(property.price, property.offPercent)}
                                <span className="ml-1 text-base text-[#8C959F] font-normal self-end">
                  -{property.offPercent}%
                </span>
                            </>
                        ) : (
                    ...
                    <div>
                        <Link
                            className="items-center font-semibold text-gray-500 text-lg hidden xl:flex"
