...
const AgentCard = ({agent}: Props) => {
    return (
        <div className="relative h-[460px]">
            <div
                className="before:absolute before:top-0 before:left-0 before:w-full before:h-[80%] before:border before:border-solid before:border-[#e3e3e3] before:mt-[92px] before:-z-10">
